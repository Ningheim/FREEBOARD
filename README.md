...
1. Put the `Plastic Window` into the slot on the inside of the `Base Case`, The window is meant to be made out of clear material like transparent plastic or something so you can see the Silkscreen design on the bottom side of the board.
